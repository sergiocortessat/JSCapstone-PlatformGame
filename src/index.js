...
//     if (this.player.body.touching.down || this.playerJumps < 2) {
...
const gameOptions = {
  ...
  mountainSpeed: 80,
  logo  // spawn range, how far should be the rightmost platform from the right edge
...
class preloadGame extends Phaser.Scene {
  ...
  preload() {
    this.load.image('platform', '../../../assets/phaser_assets/platform.png');

    // player is a sprite sheet made by 24x48 pixels
    this.load.spritesheet('player', '../../../assets/phaser_assets/player.png', {
      frameWidth: 24,
      frameHeight: 48,
    });

    // the coin is a sprite sheet made by 20x20 pixels
    this.load.spritesheet('coin', '../../../assets/phaser_assets/coin.png', {
      frameWidth: 20,
      frameHeight: 20,
    });

    // the firecamp is a sprite sheet made by 32x58 pixels
    this.load.spritesheet('fire', '../../../assets/phaser_assets/fire.png', {
      frameWidth: 40,
      frameHeight: 70,
    });

    // mountains are a sprite sheet made by 512x512 pixels
    this.load.spritesheet('mountain', '../../../assets/phaser_assets/mountain.png', {
      frameWidth: 512,
      frameHeight: 512,
    });
  }
