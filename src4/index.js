...
import LoginScene from './phaser_js/scenes/InputScene';
// import Board from './phaser_js/scenes/LeaderBoardScene';
import Model from './Model';
import GameOverScene from './phaser_js/scenes/GameOverScene';
...
class Game extends Phaser.Game {
  constructor() {
    ...
    this.scene.add('Input', LoginScene);
...
//     this.load.image('player', 'assets/phaser_assets/player.png');
//   }
